...
// import { EntityToolbars } from "../../models/entityToolbars.model";
...
// interface TableDataProps<T extends MRT_RowData> {
//   dataTypes: {
//     isError?: boolean;
//     isLoading?: boolean;
//     isFetching?: boolean;
...
// const EntityTable = <T extends MRT_RowData>(props: EntityTableProps<T>) => {
...
//       ? { filter: [] }
//       : {
//           filter: columnFilters.map((filter: any) => [{
//             field: filter.id,
//             value: filter.value,
//             operator: "like",
//           }]),
...
//       const sortedData = _.cloneDeep(tableData).sort((a: any, b: any) => {
...
//       density: (props.tableDensity ?? 'md') as MRT_DensityState 
//     },
...
//   const table = useMantineReactTable<T>(tableConfig);
